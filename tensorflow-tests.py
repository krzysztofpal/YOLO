...
# load the MNIST data set (it is already split into train and test sets)
(x_train, y_train), (x_test, y_test) = mnist.load_data()

# reshape the data into 4D tensor - (sample_number, x_img_size, y_img_size, num_channels)
# because the MNIST is greyscale - it only has one channel
...
# convert class vectors to binarry class matrices
